...
KNEE_SPEED_REV_S      = 8.0   # B/X: motor rev/s while held. Must be big enough
                              # that pos_gain × (step/fire) > current_lim to stay
                              # in current-saturation territory and not jerk.
